...
interface UriaResources {
    ...
    enum class View(override val input: String, override val output: String) : Resources {
        ...
        VIEW_INSTALLER("view/viewinstaller.tp", "Assets/Scripts/%PROJECT_NAME%/View/Scenes/%PASCAL_NAME%/%PASCAL_NAME%Installer.cs")
    }

    enum class UseCase(override val input: String, override val output: String) : Resources {
        USECASE("domain/usecase.tp", "Assets/Scripts/%PROJECT_NAME%/Domain/UseCase/%PASCAL_NAME%/%PASCAL_NAME%UseCase.cs"),
        IUSECASE("domain/iusecase.tp", "Assets/Scripts/%PROJECT_NAME%/Domain/UseCase/%PASCAL_NAME%/I%PASCAL_NAME%UseCase.cs"),
    }
